...
This document does **EVERYTHING** in one place:
1. ✅ Trains the spam classifier
2. ✅ Evaluates performance
3. ✅ Tests new emails

**Results:** 95-99% accuracy in detecting spam emails.
...
## TEST YOUR OWN EMAIL HERE!

```{r test-spam email}
# Test Your Email HereL:
my_test_email <- "Enter your email text here to test it!"
...
1. Loaded 1,000 emails (500 spam + 500 ham)
...
1. Change the folder paths at the top
2. Click "Knit to HTML" again
